...
$().ready(function(){
  ...
  //END limit tabbing within navigation panel once triggered
  ...
  // START main navigation trigger
      ...
      $('#nav_announce').html('Resource navigation activated.');
      $('#main-menu-label').html('Main Menu Active');
      $('#main_menu a[href="index.html"]').focus();
  	});
  	$('#menu_close').click(function(event){
  		event.preventDefault();
  		$('#main_menu_trigger a').show();
  		$('#myNav').css('width','0%').css('display','none');
      $('#main-menu-label').html('Main Menu Inactive');
      $('#nav_announce').html('');
      $('#main_menu_trigger a').focus();
  	});
	///////////////////////////////////////////////////////////////////
